...
https://docs.djangoproject.com/en/5.1/topics/se    # AWS region configuration (allow override via environment)
    AWS_S3_REGION_NAME = os.getenv("AWS_DEFAULT_REGION", "us-west-2")

    # AWS Bedrock region configuration (can be different from S3)
    AWS_BEDROCK_REGION_NAME = os.getenv("AWS_BEDROCK_REGION", "us-west-2")s/
