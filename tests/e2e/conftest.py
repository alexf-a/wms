...
@pytest.fixture(autouse=True)
def mock_wms_llm(request: pytest.FixtureRequest, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    Tests marked with ``@pytest.mark.real_llm`` skip this mock so the
    WMS app makes real LLM calls.
    """
