...
def test_perform_candidate_search_wiring(monkeypatch, scenario, confidences, expects_location_call) -> None:
    ...
    from lib.llm.llm_search import get_item_location, perform_candidate_search
    ...
    class MockHandler:
        ...
        def query(self, **kwargs: Any):
            ...
            if hasattr(self, "_llm_call_name"):
                ...
                if self._llm_call_name == "mock_location_llm_call":
            ...
            elif candidates_query_args is None:
